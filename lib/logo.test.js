...
describe('Shape Object Tests', () => {
    describe('Circle drawShape Returns Correct Content', () => {
      it('should return correct svg text content', () => {
          ...
          expect(circle.drawShape()).toEqual(`<circle cx="150" cy="96" r="50" fill="green" fill-opacity="1.0"/>`);
      });
    });
    ...
    describe('Square drawShape Returns Correct Content', () => {
        it('should return correct svg text content', () => {
            ...
            expect(square.drawShape()).toEqual(`<rect x="100" y="46" width="100" height="100" fill="blue" fill-opacity="1.0"/>`);
        });
    });
    ...
    describe('Triangle drawShape Returns Correct Content', () => {
        it('should return correct svg text content', () => {
            ...
            expect(triangle.drawShape()).toEqual(`<polygon points="150 20, 230 150, 70 150" fill="red" fill-opacity="1.0"/>`);
        });
    });
